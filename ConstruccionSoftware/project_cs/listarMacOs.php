...
<body>
 ...
 <ul class="nav justify-content-center" style="font-size:24px">
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="listardistriversionM.php">Distribuciones o Versiones</a>
  </li>

  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="listarprovedorM.php">Provedor</a>
  </li>
 ...
 <br/>  
    ...
    <tbody>
        <?php 
            $query = "SELECT * FROM sistemaOperativo where nombresis='MacOS'";
